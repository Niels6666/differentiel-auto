...
/**
 * <p>
 * Ma propre classe qui hérite de TypedConstraint pour pouvoir modifier quand je veux le vecteur pivot.
 * </p>
 * <p>
 * C'est en fait une copie de HingeConstraint avec la méthode setPivotsAndAxis en plus.
 * </p>
 */
public class SteeringConstraint extends TypedConstraint {
	...
	public SteeringConstraint(RigidBody rbA, RigidBody rbB, Vector3f pivotInA, Vector3f pivotInB, Vector3f axisInA,
			Vector3f axisInB) {
		super(TypedConstraintType.HINGE_CONSTRAINT_TYPE, rbA, rbB);
		angularOnly = false;
		enableAngularMotor = false;

		setPivotsAndAxis(pivotInA, pivotInB, axisInA, axisInB);
	...
	public void setPivotsAndAxis(Vector3f pivotInA, Vector3f pivotInB, Vector3f axisInA, Vector3f axisInB) {
